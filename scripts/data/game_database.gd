...
const SHOT_PROFILE_FIELDS := {
	"ofuda_trace": {"hud_name": "Ofuda Trace", "type_label": "Type A", "pattern_id": "miko_tracking_ofuda", "bullet_type": "homing", "fire_interval_frames": 3, "base_damage": 1.05, "bullet_speed": 5.4, "coverage": "wide tracking", "focused_damage": "low", "difficulty_hint": "safe learning shot", "color": Color(0.31, 1.0, 0.55)},
	"yin_yang_focus": {"hud_name": "Yin-Yang Focus", "type_label": "Type B", "pattern_id": "miko_yinyang_focus", "bullet_type": "linear", "fire_interval_frames": 4, "base_damage": 3.6, "bullet_speed": 9.2, "coverage": "narrow forward", "focused_damage": "medium", "difficulty_hint": "focused boss route", "color": Color(1.0, 0.31, 0.31)},
	"stardust_spread": {"hud_name": "Stardust Spread", "type_label": "Type A", "pattern_id": "magician_stardust_spread", "bullet_type": "spread", "fire_interval_frames": 3, "base_damage": 1.65, "bullet_speed": 7.4, "coverage": "wide close range", "focused_damage": "medium", "difficulty_hint": "screen coverage route", "color": Color(0.71, 0.31, 1.0)},
	...
	"sword_wave_fan": {"hud_name": "Sword Wave Fan", "type_label": "Type A", "pattern_id": "swordswoman_wave_fan", "bullet_type": "spread", "fire_interval_frames": 3, "base_damage": 1.55, "bullet_speed": 8.0, "coverage": "midrange fan", "focused_damage": "medium", "difficulty_hint": "aggressive screen control", "color": Color(0.71, 0.31, 1.0)},
	"returning_spirit_blades": {"hud_name": "Returning Spirit Blades", "type_label": "Type B", "pattern_id": "swordswoman_returning_blades", "bullet_type": "homing", "fire_interval_frames": 4, "base_damage": 2.3, "bullet_speed": 6.4, "coverage": "returning homing blades", "focused_damage": "medium", "difficulty_hint": "mobile routing shot", "color": Color(0.31, 1.0, 0.55)},
}

const BOMB_PROFILE_FIELDS := {
	"miko": {"hud_name": "Great Boundary Bloom", "behavior_id": "boundary_bloom", "duration_frames": 150, "waves": 6, "clear_radius": 520.0, "damage": 1.35, "boss_damage_per_wave": 40.0, "bullet_count": 36, "speed": 4.2, "color": Color(0.78, 0.39, 1.0), "description": "full-field clear then sustained boundary pulses"},
	"magician": {"hud_name": "Festival Master Spark", "behavior_id": "master_spark", "duration_frames": 78, "waves": 5, "clear_radius": 120.0, "damage": 4.2, "boss_damage_per_wave": 48.0, "bullet_count": 9, "speed": 11.0, "color": Color(1.0, 0.31, 0.31), "description": "directional high damage laser burst"},
	"swordswoman": {"hud_name": "Instant Slash Boundary", "behavior_id": "instant_slash", "duration_frames": 96, "waves": 8, "clear_radius": 170.0, "damage": 3.2, "boss_damage_per_wave": 34.0, "bullet_count": 7, "speed": 9.0, "color": Color(0.31, 1.0, 0.55), "description": "instant path clear slashes"},
}
...
const DROP_TABLES := {
	"light": [
		{"id": "power", "weight": 0.43},
		{"id": "point", "weight": 0.34},
		{"id": "bomb_fragment", "weight": 0.10},
		{"id": "life_fragment", "weight": 0.04},
		{"id": "night_festival_seal", "weight": 0.08},
		{"id": "full_power", "weight": 0.01},
	],
	"standard": [
		{"id": "power", "weight": 0.38},
		{"id": "point", "weight": 0.32},
		{"id": "bomb_fragment", "weight": 0.13},
		{"id": "life_fragment", "weight": 0.06},
		{"id": "night_festival_seal", "weight": 0.10},
		{"id": "full_power", "weight": 0.01},
	],
	"rich": [
		{"id": "point", "weight": 0.31},
		{"id": "bomb_refill", "weight": 0.01},
		{"id": "bomb_fragment", "weight": 0.29},
		{"id": "life_fragment", "weight": 0.15},
		{"id": "life", "weight": 0.01},
		{"id": "night_festival_seal", "weight": 0.22},
		{"id": "full_power", "weight": 0.01},
	],
	"mechanism": [
		{"id": "power", "weight": 0.35},
		{"id": "point", "weight": 0.28},
		{"id": "bomb_fragment", "weight": 0.13},
		{"id": "life_fragment", "weight": 0.06},
		{"id": "night_festival_seal", "weight": 0.16},
		{"id": "full_power", "weight": 0.02},
	],
}
