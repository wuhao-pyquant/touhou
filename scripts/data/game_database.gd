...
const BOMB_PROFILE_FIELDS := {
	"miko": {"hud_name": "Great Boundary Bloom", "behavior_id": "boundary_bloom", "duration_frames": 150, "waves": 6, "clear_radius": 1200.0, "damage": 0.35, "boss_damage_ratio": 0.12, "bullet_count": 36, "speed": 4.2, "color": Color(0.78, 0.39, 1.0), "description": "full-field clear then sustained boundary pulses"},
	"magician": {"hud_name": "Festival Master Spark", "behavior_id": "master_spark", "duration_frames": 108, "waves": 5, "clear_radius": 120.0, "damage": 1.2, "boss_damage_ratio": 0.18, "bullet_count": 9, "speed": 11.0, "color": Color(1.0, 0.31, 0.31), "description": "directional high damage laser burst"},
	"swordswoman": {"hud_name": "Instant Slash Boundary", "behavior_id": "instant_slash", "duration_frames": 120, "waves": 8, "clear_radius": 170.0, "damage": 0.8, "boss_damage_ratio": 0.15, "bullet_count": 7, "speed": 9.0, "color": Color(0.31, 1.0, 0.55), "description": "instant path clear slashes"},
}
...
const BULLET_FAMILY_FIELDS := {
	...
	"arrow": {"radius": 4.5, "speed_multiplier": 1.3, "collision_radius": 3.5, "color": Color(1.0, 0.5, 0.2), "draw_group": "fast_shard"},
	"clock_gear": {"radius": 6.0, "speed_multiplier": 0.85, "collision_radius": 5.0, "color": Color(0.95, 0.3, 0.55), "draw_group": "gear"},
	"storm_arc": {"radius": 5.0, "speed_multiplier": 1.1, "collision_radius": 4.0, "color": Color(0.35, 0.78, 1.0), "draw_group": "arc"},
	"spiral_seed": {"radius": 4.5, "speed_multiplier": 0.9, "collision_radius": 4.0, "color": Color(0.82, 0.35, 1.0), "draw_group": "seed"},
}
...
const BULLET_FAMILIES := [
	...
	{"id": "arrow", "display_name": "箭片", "collision": "thin", "role": "fast_lane_check"},
	{"id": "clock_gear", "display_name": "时轮", "collision": "round", "role": "turning_anchor"},
	{"id": "storm_arc", "display_name": "风弧", "collision": "thin", "role": "curved_pressure"},
	{"id": "spiral_seed", "display_name": "旋种", "collision": "round", "role": "delayed_activation"},
]
